            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Member
                        </th>
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Amount
                        </th>
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Payment
                            Method
                        </th>
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Date
                        </th>
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Due Date
                        </th>
                        <th class="text-left p-3 text-gray-400 font-normal text-sm border-b border-gray-700"> Status
                        </th>
                ...
                <tbody>
                    <?php foreach ($payments as $record): ?>
                        <tr>
                            ...
                            <td class="p-3 border-b border-gray-700"><?= htmlspecialchars($record['amount']); ?></td>
                            ...
                            <td class="p-3 border-b border-gray-700">
                                <span
                                    class="status <?= strtolower($record['membership_status']); ?>"><?= htmlspecialchars($record['membership_status']); ?>
                                </span>
                            </td>
