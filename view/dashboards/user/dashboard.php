        ...
        <div class="bg-[#121f2e] p-6 rounded-xl shadow-md">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    ...
                    <span
                        class="text-orange-400 font-semibold"><?= htmlspecialchars($membership_status['plan_name']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-300">Membership Plan:</span>
                    <span
                        class="text-orange-400 font-semibold"><?= htmlspecialchars($membership_status['status']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-300">Last Payment:</span>
                    <span
                        class="text-orange-400 font-semibold"><?= htmlspecialchars($membership_status['last_payment']); ?></span>
                </div>
            </div>
        </div>
    </div>

    <!-- if user is a memeber -->

    <?php if ($membership_status['status'] === 'Inactive'): ?>
    ...
    <?php if ($membership_status['status'] === 'Active'): ?>
        ...
        <div class="bg-[#121f2e] p-6 rounded-xl shadow-md w-full mt-10">
            ...
            <?php if (!empty($_SESSION['errors'])): ?>
                ...
                <?php unset($_SESSION['errors']); // clear after displaying ?>
            <?php endif; ?>
